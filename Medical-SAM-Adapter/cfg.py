...
def parse_args():    
    ...
    parser.add_argument('-vis', type=int, default=39, help='visualization')
    ...
    parser.add_argument('-dataset', default='imc' ,type=str,help='dataset name')
    parser.add_argument('-sam_ckpt', default='/mnt/mydisk/zzf/Medical-SAM-Adapter/checkpoint/sam_vit_b_01ec64.pth', help='/mnt/mydisk/zzf/Medical-SAM-Adapter/checkpoint/sam_vit_b_01ec64.pth')
    parser.add_argument('-thd', type=bool, default=False , help='3d or not')
    parser.add_argument('-chunk', type=int, default=None , help='crop volume depth')
    parser.add_argument('-point_num', type=int, default=1 , help='prompt number')
    ...
    parser.add_argument('-data_path', type=str, default='/home/zzf/dataset/IMC_Cell/Dice-XMBD/datas/melanoma/IMC_fullstacks/', help='The path of segmentation data')
    parser.add_argument('-label_path', type=str, default='/mnt/mydisk/zzf/IMC_seg_cell_20/', help='The path of label data')
    parser.add_argument('-hv_path', type=str, default='/mnt/mydisk/zzf/IMC_seg_cell_hv/', help='The path of label data')
    parser.add_argument('-mean_std_path', type=str, default='/home/zzf/dataset/IMC_Cell/Dice-XMBD/datas/melanoma/ch_dict.pkl', help='mean std data')
