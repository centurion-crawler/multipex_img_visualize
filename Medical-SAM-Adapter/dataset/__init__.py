...
from .wbc import WBC
from .imc import IMCdataset, IMCdataset_Test 
...
def get_dataloader(args):
    ...
    if args.dataset == 'imc':
        imc_train_dataset = IMCdataset(args, args.data_path, args.mean_std_path, args.label_path, mode='Training')
        imc_val_dataset = IMCdataset(args, args.data_path, args.mean_std_path, args.label_path, mode='Validing')

        nice_train_loader = DataLoader(imc_train_dataset, batch_size=args.b, shuffle=True, num_workers=8, pin_memory=True)
        nice_test_loader = DataLoader(imc_val_dataset, batch_size=args.b, shuffle=True, num_workers=8, pin_memory=True)
    if args.dataset == 'imc_test':
        imc_test_dataset = IMCdataset_Test(args, args.data_path, args.mean_std_path, args.label_path, mode='Testing')

        nice_test_loader = DataLoader(imc_test_dataset, batch_size=args.b, shuffle=True, num_workers=8, pin_memory=True)
        nice_train_loader = nice_test_loader
